...
label start:
    ...
    j "{i}It was weird, to say the least.{/i}"
    j "{i}It had been about 2 weeks since I last heard from him, and here he was all of a sudden, sitting beside me quite rudely on a desk, not even acknowledging my presence.{/i}"
    j "Oh, you’re back. Hi."
    ...
    j "{i}I guessed something happened when he was gone, more than just being sick.{/i}" 
    j "{i}The look on his face and his change in mannerisms since I last saw him was weird, even for him.{/i}"
    ...
    j "{i}I thought maybe he had a fever.{/i}"
    j "{i}I couldn’t think of any other explanation for a question so out there after having disappeared from school for a couple weeks. Fevers do weird things to people right?{/i}"
    ...
    j "{i}I don’t think I’ve ever seen Finn like this before, so... emotional?"
    j "{i}We haven't known each other for long, but he never seemed like the type to just break down in front of people like this. Respectfully.{/i}"
